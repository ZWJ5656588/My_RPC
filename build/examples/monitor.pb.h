...
PROTOBUF_NAMESPACE_OPEN
template<> ::monitor::TestRequest* Arena::CreateMaybeMessage<::monitor::TestRequest>(Arena*);
template<> ::monitor::TestResponse* Arena::CreateMaybeMessage<::monitor::TestResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace monitor {
...
class TestRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:monitor.TestRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:monitor.TestRequest)
 private:
  class _Internal;
...
class TestResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:monitor.TestResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:monitor.TestResponse)
 private:
  class _Internal;
...
class TestService : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void MonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class TestService_Stub : public TestService {
 public:
  ...
  void MonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::monitor::TestRequest* request,
                       ::monitor::TestResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
inline const std::string& TestRequest::name() const {
  // @@protoc_insertion_point(field_get:monitor.TestRequest.name)
  return _internal_name();
}
inline void TestRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:monitor.TestRequest.name)
}
inline std::string* TestRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:monitor.TestRequest.name)
...
inline void TestRequest::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:monitor.TestRequest.name)
}
inline void TestRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:monitor.TestRequest.name)
}
inline void TestRequest::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:monitor.TestRequest.name)
}
...
inline std::string* TestRequest::release_name() {
  // @@protoc_insertion_point(field_release:monitor.TestRequest.name)
...
inline void TestRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:monitor.TestRequest.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TestRequest::count() const {
  // @@protoc_insertion_point(field_get:monitor.TestRequest.count)
...
inline void TestRequest::set_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:monitor.TestRequest.count)
}
...
inline bool TestResponse::_internal_status() const {
  return status_;
}
inline bool TestResponse::status() const {
  // @@protoc_insertion_point(field_get:monitor.TestResponse.status)
  return _internal_status();
}
inline void TestResponse::_internal_set_status(bool value) {
  
  status_ = value;
}
inline void TestResponse::set_status(bool value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:monitor.TestResponse.status)
}

// string cpu_info = 2;
inline void TestResponse::clear_cpu_info() {
  cpu_info_.ClearToEmpty();
}
inline const std::string& TestResponse::cpu_info() const {
  // @@protoc_insertion_point(field_get:monitor.TestResponse.cpu_info)
  return _internal_cpu_info();
}
inline void TestResponse::set_cpu_info(const std::string& value) {
  _internal_set_cpu_info(value);
  // @@protoc_insertion_point(field_set:monitor.TestResponse.cpu_info)
}
inline std::string* TestResponse::mutable_cpu_info() {
  // @@protoc_insertion_point(field_mutable:monitor.TestResponse.cpu_info)
  return _internal_mutable_cpu_info();
}
inline const std::string& TestResponse::_internal_cpu_info() const {
  return cpu_info_.Get();
}
inline void TestResponse::_internal_set_cpu_info(const std::string& value) {
  
  cpu_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TestResponse::set_cpu_info(std::string&& value) {
  
  cpu_info_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:monitor.TestResponse.cpu_info)
}
inline void TestResponse::set_cpu_info(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  cpu_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:monitor.TestResponse.cpu_info)
}
inline void TestResponse::set_cpu_info(const char* value,
    size_t size) {
  
  cpu_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:monitor.TestResponse.cpu_info)
}
inline std::string* TestResponse::_internal_mutable_cpu_info() {
  
  return cpu_info_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TestResponse::release_cpu_info() {
  // @@protoc_insertion_point(field_release:monitor.TestResponse.cpu_info)
  return cpu_info_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TestResponse::set_allocated_cpu_info(std::string* cpu_info) {
  if (cpu_info != nullptr) {
  ...
  cpu_info_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), cpu_info,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:monitor.TestResponse.cpu_info)
}
